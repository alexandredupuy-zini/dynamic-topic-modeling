...
def train_val_test(dataset : pd.DataFrame,dictionary : Dictionary , corpus : MmCorpus, 
    ...
    bow_val = create_bow(doc_indices_va, words_va, n_docs_va, len(vocab))
    ...
    print(' Val bag of words shape : {}'.format(bow_val.shape))
    ...
    return dict(
        bow_train=bow_tr,
        bow_test_full=bow_ts,
        bow_test_set1=bow_ts_h1,    
        bow_test_set2=bow_ts_h2,
        bow_val=bow_val,
