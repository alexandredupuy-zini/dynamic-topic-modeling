...
# dynamic_topic_modeling documentation build
...
from dynamic_topic_modeling import __version__ as release

# -- Project information -----------------------------------------------------

project = "dynamic_topic_modeling"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "dynamic_topic_modelingdoc"
...
latex_documents = [
    (
        master_doc,
        "dynamic_topic_modeling.tex",
        "dynamic_topic_modeling Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "dynamic_topic_modeling",
        "Project dynamic_topic_modeling codebase.",
        "Data-Science",
    )
]
